...
export class UserPreferencesClient {
    ...
    getAll(userId: string | undefined): Observable<void> {
    ...
    get(userId: string): Observable<UserPreferences> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UserPreferences>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserPreferences>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<UserPreferences> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 401) {
            ...
            result200 = UserPreferences.fromJS(resultData200);
        ...
        return _observableOf<UserPreferences>(null as any);
    }

    create(userId: string, userPreferences: UserPreferences): Observable<UserPreferences> {
        let url_ = this.baseUrl + "/api/user/preferences/{userId}";
        if (userId === undefined || userId === null)
            throw new Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
    ...
    protected processCreate(response: HttpResponseBase): Observable<UserPreferences> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    update(userId: string): Observable<void> {
        let url_ = this.baseUrl + "/api/user/preferences/{userId}";
        if (userId === undefined || userId === null)
            throw new Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
...
export class RepositoryEntity implements IRepositoryEntity {
    ...
    constructor(data?: IRepositoryEntity) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RepositoryEntity {
        data = typeof data === 'object' ? data : {};
        let result = new RepositoryEntity();
        result.init(data);
        return result;
    }
...
export class UserPreferences extends RepositoryEntity implements IUserPreferences {
    title?: string | undefined;
    ...
    static fromJS(data: any): UserPreferences {
        data = typeof data === 'object' ? data : {};
        let result = new UserPreferences();
        result.init(data);
        return result;
    }
...
export interface IUserPreferences extends IRepositoryEntity {
    title?: string | undefined;
    description?: string | undefined;
}
